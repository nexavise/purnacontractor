...
export default function Process() {
  return (
    <section className="p-process-section">
      <div className="p-process-wrapper">
        {/* TITLE */}
        <motion.h2
          className="p-process-title"
        ...
        <div className="p-process-box">
          <div className="s-process-container">
            ...
            {/* ✅ FIXED: class name matches CSS */}
            <div className="p-process-step">
              {/* STEP 01 */}
              <motion.div
                className="p-step p-step-1"
                variants={fade({ direction: "up", duration: 0.8 })}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
              >
                ...
                <div className="p-step-content">
                  ...
                  <p>
                    Articulating your vision and defining parameters for
                    excellence.
                  </p>
                </div>
              </motion.div>
