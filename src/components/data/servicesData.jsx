...
import interor1 from "../../images/services/interar-1.jpeg";
import interor3 from "../../images/services/interar-2.jpeg";

import exteriorBg from "../../images/services/exterar.jpg";
import exteror2 from "../../images/services/extera2.jpeg";
import exteror3 from "../../images/services/exterar3.jpeg";

// /* ===== IMPORT CARD IMAGES ===== */
import work3 from "../../images/services/exterar1.jpeg";
...
import woodnBg from "../../images/differentserv/woodntex-1.jpg";
import pol1 from "../../images/differentserv/polish-2.jpg";
import pol2 from "../../images/differentserv/gloss-1.jpg";
...
const servicesData = {
  "interior-painting": {
    ...
    cards: [
      { title: "Wall & Ceiling Painting", desc: "Smooth, long-lasting finishes.", image: interor1 },
      { title: "Texture Walls", desc: "Designer textured interiors.", image: work13 },
      { title: "Repainting", desc: "Fresh coats for old interiors.", image: interor3 },
    ],
  },
  ...
  "special-effect": {
    pageBg: woodnBg,
    title: "Special-effect Painting",
    desc: "",
    cards: [
      { title: "High gloss polish", desc: "Crack-free smooth walls.", image: pol1 },
      { title: "PU polish", desc: "Strong paint base.", image: pol2 },
      // { title: "Exterior Putty", desc: "Weather resistant.", image: putty3 },
    ],
  }
