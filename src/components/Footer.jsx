  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-col">
          ...
          <div className="social-icons">
            <a
              href="https://www.facebook.com/profile.php?id=61585996025242"
              target="_blank"
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <NavLink to="/services/special-effect">
        ...
        <div className="footer-col">
          ...
          <p>
            <FaEnvelope className="footer-col-icon" /> purnacontractor1983@gmail.com
          </p>
          <p>
      ...
      <div className="footer-bottom">
        <p>
          © {new Date().getFullYear()} PURNA CONTRACTORS. All rights reserved.
        </p>
